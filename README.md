...
Run TimeWise.exe to start the application
No additional setup or configuration required!
📖 Usage
Getting Started
Launch TimeWise - Double-click the application icon
Create Your First Appointment - Click "New Appointment" and fill in the details
Choose Your View - Switch between Daily and Weekly views using the view toggle
Navigate Dates - Use navigation buttons or date picker to browse your schedule
